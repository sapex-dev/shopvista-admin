...
// import { setAdminLogout } from "../../../redux/adminAuthSlice";
        ...
        <ul className="space-y-2 font-medium">
          ...
          <li>
            <Link
              to="/users"
              className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                location.pathname === "/users" ? "bg-blue-700 text-white " : ""
              }`}
            >
              <svg
          ...
          <li>
            <Link
              ...
              className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                ...
                location.pathname === `/product/update/${slug}`
          ...
          <li>
            <Link
              ...
              className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 ${
                location.pathname === "/stocks" ? "bg-blue-700 text-white " : ""
              }`}
            >
              <MdCategory
                size={23}
          ...
          <li>
            <Link
              to="/faq"
              className={`flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group ${
                location.pathname === "/faq" ? "bg-blue-700 text-white " : ""
              }`}
            >
              <FaQuestionCircle
                size={23}
          ...
          <li>
            <Link
              ...
              className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-red-200 dark:hover:bg-gray-700 group"
            >
              <svg
                className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                aria-hidden="true"
        ...
        <Modal.Body>
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4">
              <Button color="failure" onClick={() => handleLogOut(false)}>
                {"Sign Out"}
              </Button>
